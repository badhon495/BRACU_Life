...
Here, the same Dijkstra's algorithm have been used.
For Alice and Bob, I returned two lists which contain minimum distance from source nodes.
Then found the time and the meeting node.
"""